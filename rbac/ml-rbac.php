 ...
 * rbac/ml-rbac.php
 *
 * CLI helper to create a Role-Based Access Control table for a project.
 * Usage:
 *  php rbac/ml-rbac.php <project_name>
 *  php rbac/ml-rbac.php        # prompts for table name
 */
...
if ($project === null) {
    fwrite(STDOUT, "To create a new Role Based Access Control table for your project, please provide a table name.\n\nTable name: ");
...
$rbacTable = $project . '_rbac';
$pk = $project . '_no';
$fkName = 'fk_' . $project . '_rbac_user';
